      ...
      message.stats.each do | flow_msg |
        ...
        if(flow_msg.actions[0].port_number == @left)
            ...
            if flow_msg.duration_sec + flow_msg.duration_nsec/1000000000 != 0
              left_tp += flow_msg.byte_count/(flow_msg.duration_sec + flow_msg.duration_nsec/1000000000)
            ...
            if flow_msg.duration_sec + flow_msg.duration_nsec/1000000000 != 0
              right_tp += flow_msg.byte_count/(flow_msg.duration_sec + flow_msg.duration_nsec/1000000000)
